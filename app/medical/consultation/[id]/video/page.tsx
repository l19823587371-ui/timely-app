...
import VideoCallView from "@/components/medical/VideoCallView";
import LoadingSpinner from "@/components/shared/LoadingSpinner";
import { getSOSAlert } from "@/lib/api";
import type { SOSAlert } from "@/types/sos";

interface VitalsOverlay {
  heartRate?: number;
  spo2?: number;
...
export default function VideoConsultationPage() {
  ...
  if (loading) return <LoadingSpinner message="建立视频连接..." />;
  ...
  // Mock vitals overlay for the video view
  const mockVitals: VitalsOverlay = {
    heartRate: 78,
    spo2: 97,
